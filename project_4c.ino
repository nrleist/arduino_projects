...
const char* words[arraySize] = {"Harp", "Trumpet", "Clarinet", "Cello", "Flute", "Saxophone", "Guitar", "Percussion",
                               "Violin", "Electric Guitar", "Drums", "Classical Guitar", "Recorder", "Piano", "Keyboard"};
...
void showStartSequence() {
  ...
  lcd.print("Instruments");         //print "Animals:"
