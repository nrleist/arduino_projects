...
int button[] = {2, 3, 4, 11};  //red is button[0], yellow is button[1], green is button[2], blue is button[3]
int led[] = {5, 6, 7, 12};     //red is led[0], yellow is led[1], green is led[2], blue is led[3]
int tones[] = {500, 400, 300, 200};   //tones to play with each button (c, e, g, b)
...
int buzzerPin = 9;           //pin that the buzzer is connected to
